  ...
  const certifications = [
    {
      ...
      imageUrl: "./images/certs_development.png",
    },
    {
      year: "2022",
      ...
      imageUrl: "./images/certs_coach.png",
    },
    {
      year: "2018",
      ...
      imageUrl: "./images/certs_web-analytics.png",
    },
    {
      year: "2014",
      ...
      imageUrl: "./images/certs_collaboration.png",
    },
  ];

  return (
    <div className='flex overflow-x-auto space-x-5 pr-4 justify-center'>
