    ...
    <div className='relative flex max-w-[24rem] flex-col overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700 shadow-md'>
      ...
      <div className='p-6'>
        ...
        <div className='flex flex-wrap items-end justify-between mt-3'>
          ...
          <button className='items-center px-3 py-2 border rounded text-rose-300 border-rose-300 bg-rose-100 hover:text-rose-600 hover:border-rose-600 hover:bg-rose-200 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none'>
            <Link
              to={repo.html_url}
              className='text-sm'
              target='_blank'
              rel='noopener noreferrer'
            >
              <div className='flex flex-overflow'>
                <p>Go to {repo.name}</p>
